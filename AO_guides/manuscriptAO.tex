...
\caption{Comparison of observed and modelled winds during Dec 2012 storm surge simulation at Point Atkinson (upper) and Sandheads (lower). Observed winds shown in solid black, low resolution CGRF model in dashed black and high resolution model in grey. Observations {\color{red} from Sandheads and Point Atkinson} \are from the Environment Canada Climate Data archives \citep{ECClimateArchive}. {\color{red} Observations at the NOAA Buoy are found at this url: http://www.ndbc.noaa.gov/station_page.php?station=46087. Wind direction represents the direction that the wind is headed.} }
