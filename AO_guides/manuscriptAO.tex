...
\begin{table}[h]
\centering 
\tbl{{\color{red}Average surge amplitudes and delay in peak timing from Tofino at several tide gauges on the Pacific coast. Averages obtained over the five surge events discussed on this article. A negative delay indicates that the peak surge occurred later than at Tofino.}} 
{\begin{tabular}{|l |c | c|}
\hline 
...
The model's skill is reported in terms of statistical measures of the total water level $\eta$ and the residual $\delta$. First, the mean absolute error ($\bar{e}$), defined as
\begin{equation}
