...
\vspace{6pt}}, Susan Allen$^{1}$,  Doug Latornell$^{1}$,  Kate Le Sou\"{e}f$^{1}$, Idalia Machuca$^{1}$ \\ 
Youyu Lu$^{2}$, Keith Thompson$^{3}$, Jean-Philippe Paquin$^{3}$, Vasily Korabel$^{3}$
\\\vspace{6pt}  $^{1}${\em{University of British Columbia}};
$^{2}${\em{Bedford Insitute of Oceanography}}; 
$^{3}${\em{Dalhousie University}}\\\received{v1.2 released April 2014} }
