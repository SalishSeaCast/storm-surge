...
%Need something about SoG size, geography, islands, sills, rivers....

%my attempt at physical oceanopgraphy in SoG- Susan feel free to edit.
...
Early work by \citet{crean1988numerical, crean1988mathematical, stronach1993update} resulted in a series of models covering the Strait of Juan de Fuca, the Strait of Georgia and Puget Sound using a finite difference discretization of the equations of motion. A barotropic version of their model was used to reproduce storm surge water level elevations with reasonable accuracy, however, this barotropic version did not include the effects of fresh water entering the system from rivers. Later, a baroclinc version of their model examined residual currents and more. %elaborate!
 The baroclinic model of \citet{masson2004modelling} examined seasonal variability of deep water properties in the Strait of Georgia noting a strong sensitivity to vertical mixing over the sills. This model employed a sigma vertical coordinate system leading to errors in diapycnal mixing due to steep topographics slopes. %fix this up still.
%tide models (Foreman), baroclinic (Masson, PNWL, Sutherland and MacCready)
