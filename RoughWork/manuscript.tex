...
\hline 
Location       & $\bar{e}$ (cm) & $\bar{\eta_{o}}$ (m) & $\bar{\eta_{m}}$ (m) & $\gamma^2$ & $WS$   & $\bar{e}$ (cm) & $\bar{\delta_{m}}$ (o) & $\bar{\delta_{m}}$ (m) & $\gamma^2$ & $WS$ \\
\hline 
...
Once again, an evaluation of the model skill in this hindcast is provided in Table \ref{tab:nov2009stats}.
